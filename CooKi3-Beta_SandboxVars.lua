SandboxVars = {
    ...
    NightSprinters = {
        ...
        normalZombiesToughness = 4,
        modifiedZombiesToughness = 4,
        normalZombiesHearing = 1,
        modifiedZombiesHearing = 1,
        normalZombiesSight = 3,
        modifiedZombiesSight = 3,
        normalZombiesMemory = 3,
    ...
    SprinterZones = {
        -- 최소 =1 최대 =36000 기본 =180
        TickRate = 180,
        -- 최소 =2 최대 =500 기본 =40
        AreaRadius = 40,
        -- 최소 =0.00 최대 =999999.00 기본 =0.00
        StartX = 0.0,
        -- 최소 =0.00 최대 =999999.00 기본 =0.00
        StartY = 0.0,
        -- 최소 =0.00 최대 =999999.00 기본 =0.00
